...
bool App::Init()
{
	...
	MyDX::MeshMgr::OnInit();											// メッシュ管理の初期化
	Sys::MaterialMgr::OnInit();											// マテリアル管理の初期化
	MyDX::Tool::Sound::OnInit();
	Effect::EfkMgr::OnInit(MyDX::Dx12Wrapper::GetDevice(), MyDX::Dx12Wrapper::GetQue());
...
void App::MainLoop()
{
	...
	while (WM_QUIT != msg.message)
	{
		...
		else
		{
			...
			Effect::EfkMgr::SyncronizeEffekseerCamera(MyDX::Dx12Wrapper::GetViewMatrix(), MyDX::Dx12Wrapper::GetProjMatrix());
			Effect::EfkMgr::Draw(MyDX::Dx12Wrapper::GetGCList());
...
void App::Term()
{
	...
	MyDX::Tool::Sound::OnTerm();
	Sys::MaterialMgr::OnTerm();		// マテリアル管理終了
	MyDX::MeshMgr::OnTerm();			// メッシュ管理終了
