...
namespace GameObject
{
	...
	void ResultUI::Draw()
	{
		...
		MyDX::Dx12Wrapper::DrawFont({ L"RESULT", DirectX::XMFLOAT2(300, 180), {1, 0.65f, 0, 1},{},{},0.8f });
		...
		MyDX::Dx12Wrapper::DrawFont({ L"Life", DirectX::XMFLOAT2(450, 430), {1, 0.65f, 0,1},{},{},0.5f });

		MyDX::Dx12Wrapper::DrawFont({ this->life, DirectX::XMFLOAT2(540, 505), {0.05f, 0.05f, 0.05f, 1},{},{},0.5f });
		MyDX::Dx12Wrapper::DrawFont({ this->life, DirectX::XMFLOAT2(540, 500), {1, 0.65f, 0, 1},{},{},0.5f });

		MyDX::Dx12Wrapper::DrawFont({ L"Stage", DirectX::XMFLOAT2(450, 575), {0.05f, 0.05f, 0.05f, 1},{},{},0.5f });
		MyDX::Dx12Wrapper::DrawFont({ L"Stage", DirectX::XMFLOAT2(450, 570), {1, 0.65f, 0,1},{},{},0.5f });

		MyDX::Dx12Wrapper::DrawFont({ this->phase, DirectX::XMFLOAT2(540, 645), {0.05f, 0.05f, 0.05f, 1},{},{},0.5f });
		MyDX::Dx12Wrapper::DrawFont({ this->phase, DirectX::XMFLOAT2(540, 640), {1, 0.65f, 0, 1},{},{},0.5f });

		MyDX::Dx12Wrapper::DrawFont({ L"Boss", DirectX::XMFLOAT2(450, 715), {0.05f, 0.05f, 0.05f, 1},{},{},0.5f });
		MyDX::Dx12Wrapper::DrawFont({ L"Boss", DirectX::XMFLOAT2(450, 710), {1, 0.65f, 0,1},{},{},0.5f });

		MyDX::Dx12Wrapper::DrawFont({ this->boss, DirectX::XMFLOAT2(540, 785), {0.05f, 0.05f, 0.05f, 1},{},{},0.5f });
		MyDX::Dx12Wrapper::DrawFont({ this->boss, DirectX::XMFLOAT2(540, 780), {1, 0.65f, 0, 1},{},{},0.5f });

		MyDX::Dx12Wrapper::DrawFont({ L"Total Score", DirectX::XMFLOAT2(950, 385), {0.05f, 0.05f, 0.05f, 1},{},{},0.9f });
		MyDX::Dx12Wrapper::DrawFont({ L"Total Score", DirectX::XMFLOAT2(950, 380), {1, 0.65f, 0, 1},{},{},0.9f });

		MyDX::Dx12Wrapper::DrawFont({ this->total, DirectX::XMFLOAT2(1050, 485), {0.05f, 0.05f, 0.05f, 1},{},{},0.9f });
		MyDX::Dx12Wrapper::DrawFont({ this->total, DirectX::XMFLOAT2(1050, 480), {1, 0.65f, 0, 1},{},{},0.9f });
